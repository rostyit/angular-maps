import { EventEmitter, OnChanges, OnInit, OnDestroy, SimpleChange, NgZone, AfterViewInit } from '@angular/core';
 ...
 * @export
 */
export declare class MapComponent implements OnChanges, OnInit, OnDestroy, AfterViewInit {
    private _mapService;
    private _zone;
    private _longitude;
    private _latitude;
